...
/** \brief  Delete arrayList. Borra arraylist.
 * \param pList ArrayList* Pointer to arrayList.
...
/** \brief  Get an element by index. Retorna un puntero al elemento que se encuentra en el indice especificado.
 * \param pList ArrayList* Pointer to arrayList
...
/** \brief  Find if pList contains at least one element pElement. Comprueba si existe el elemento que se le pasa como parametro
 * \param pList ArrayList* Pointer to arrayList
 * \param pElement void* Pointer to element
...
/** \brief  Set a element in pList at index position. Inserta un elemento en el ArrayList.En el indice especificado.
 * \param pList ArrayList* Pointer to arrayList
 * \param index int Index of the element
 * \param pElement void* Pointer to element
...
/** \brief  Remove an element by index. Elimina un elemento del arraList. En el índice especificado.
 * \param pList ArrayList* Pointer to arrayList
 * \param index int Index of the element
...
/** \brief Removes all of the elements from this list. Elimina todos los elementos de esta lista
 * \param pList ArrayList* Pointer to arrayList
...
/** \brief Returns an array containing all of the elements in this list in proper sequence. Devuelve una matriz que contiene todos los elementos de esta lista en la secuencia apropiada
 * \param pList ArrayList* Pointer to arrayList
...
/** \brief Increment the number of elements in pList in AL_INCREMENT elements. Incrementar el número de elementos en pList en elementos AL_INCREMENT
 * \param pList ArrayList* Pointer to arrayList
